...
public class CableCrossoverDialog extends AppCompatDialogFragment {
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(spinnerDays.getSelectedItem().toString().equalsIgnoreCase("Sunday")) {
                            String editText = "Cable Crossover: " + editTextReps.getText().toString() + " repetitions for " +
