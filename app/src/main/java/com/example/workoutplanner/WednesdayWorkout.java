...
public class WednesdayWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(WednesdayWorkout.this);
        String message = prefs.getString("wednesday", "");
    ...
    private void initToolbar() {
        getSupportActionBar().setTitle("Wednesday Workouts");
