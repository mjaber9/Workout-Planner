...
public class LateralRaiseDialog extends AppCompatDialogFragment {
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(spinnerDays.getSelectedItem().toString().equalsIgnoreCase("Sunday")) {
                            String editText = "Lateral Raise: " + editTextReps.getText().toString() + " repetitions for " +
