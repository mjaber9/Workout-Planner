...
public class TuesdayWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(TuesdayWorkout.this);
        String message = prefs.getString("tuesday", "");
    ...
    private void initToolbar() {
        getSupportActionBar().setTitle("Tuesday Workouts");
