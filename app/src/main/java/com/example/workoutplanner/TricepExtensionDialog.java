...
public class TricepExtensionDialog extends AppCompatDialogFragment {
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(spinnerDays.getSelectedItem().toString().equalsIgnoreCase("Sunday")) {
                            String editText = "Triceps Extension: " + editTextReps.getText().toString() + " repetitions for " +
