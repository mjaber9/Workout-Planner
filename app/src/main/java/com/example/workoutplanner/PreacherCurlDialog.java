...
public class PreacherCurlDialog extends AppCompatDialogFragment {
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(spinnerDays.getSelectedItem().toString().equalsIgnoreCase("Sunday")) {
                            String editText = "Preacher Curl: " + editTextReps.getText().toString() + " repetitions for " +
