...
public class FridayWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(FridayWorkout.this);
        String message = prefs.getString("friday", "");
    ...
    private void initToolbar() {
        getSupportActionBar().setTitle("Friday Workouts");
